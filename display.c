...
int display(const char *name, int overlay, char *bg, RASTER_MAP_TYPE data_type, int invert)
{
...
static int cell_draw(const char *name, struct Colors *colors, int overlay, int invert, RASTER_MAP_TYPE data_type)
{
    int cellfile;
    void *xarray;
    int cur_A_row;
...
int mask_raster_array(void *xarray, int ncols, int invert, RASTER_MAP_TYPE data_type)
{
